...
export const attributeKeys = createQueryKeyFactory("attributes");
...
export const styleKeys = createQueryKeyFactory("styles");
export const itemKeys = createQueryKeyFactory("items");
